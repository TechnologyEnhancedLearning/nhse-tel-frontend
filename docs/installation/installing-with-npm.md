...
To use NHS England TEL frontend in your projects with npm you must:
...
You will need to import a couple of things into your project before you can start using NHS England TEL frontend:
...
You should include NHS England TEL frontend JavaScript in your project to ensure that all users can use it successfully.
